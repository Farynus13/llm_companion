...
// 2. Fix function name for madvise
#define posix_madvise madvise

// 3. Fix for posix_fadvise (Optimization hint missing on 32-bit Android)
// We define the constant if missing
#ifndef POSIX_FADV_SEQUENTIAL
#define POSIX_FADV_SEQUENTIAL 2
#endif
// We turn the function into a "no-op" (do nothing) so it compiles
